...
const translations = {
  vi: {
    ...
    hero_btnArsenal: 'XEM_KHO_CÔNG_NGHỆ',
    hero_expBadge: '8+',
  ...
  en: {
    navbar_home: 'HOME',
    navbar_about: 'NARRATIVE',
    navbar_experience: 'JOURNEY',
    navbar_skills: 'ARSENAL',
    navbar_projects: 'DEPLOYMENTS',
